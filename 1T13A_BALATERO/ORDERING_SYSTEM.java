...
static String[] chickenDishes = {
    "Chicken Adobo", "Chicken Inasal", "Fried Chicken"
};

static double[] chickenDishesPrice = {
...
String currentUsername = "";
        ...
        while (running) {
            ...
            System.out.println("||============================================||");
            System.out.println("||*******  WELCOME TO MANOK NI LOLA   ********||");
            System.out.println("||                                            ||");
            ...
            if (choice == 1) {
                ...
                while (!loggedIn) {
                    System.out.println("||============================================||");
                    System.out.println("||*********  LOGIN TO MANOK NI LOLA     ******||");
                    System.out.println("||                                            ||");
                    ...
                    if (isValidLogin(inputFile, username, password)) {
                        ...
                        while (inMenu) {
                            System.out.println("||============================================||");
                            System.out.println("||   WELCOME TO MANOK NI LOLA MAIN MENU       ||");
                            System.out.println("||============================================||");
    ...
    while (orderAgain) {
        System.out.println("||==========  CHICKENS DISHES MENU  ==========||");
        for (int i = 0; i < chickenDishes.length; i++) {
            System.out.printf("|| %d. %-30s %c%.2f  ||\n", (i + 1), chickenDishes[i], piso, chickenDishesPrice[i]);
        }
        ...
        int dishChoice = -1;
        while (dishChoice < 0 || dishChoice > chickenDishes.length) {
            System.out.print("|| Select the number of the dish to order: ");
            if (scanner.hasNextInt()) {
                dishChoice = scanner.nextInt();
                scanner.nextLine();
                if (dishChoice < 0 || dishChoice > chickenDishes.length) {
        ...
        if (dishChoice == 0) {
            ...
            String selectedDish = chickenDishes[dishChoice - 1];
            double selectedPrice = chickenDishesPrice[dishChoice - 1];
            ...
            while (!(again.equalsIgnoreCase("y") || again.equalsIgnoreCase("yes") || again.equalsIgnoreCase("n") || again.equalsIgnoreCase("no"))) {
                System.out.print("|| Would you like to order another CHICKEN dish? (Y/N): ");
            ...
            if (again.equalsIgnoreCase("n") || again.equalsIgnoreCase("no")) {
                ...
                if (validPayment) {
                    ...
                    receipt.append("========== MANOK NI LOLA RECEIPT ==========\n");
    ...
    if (retryChoice == 2) {
        break; 
                ...
                while (!registered) {
                    System.out.println("||============================================||");
                    System.out.println("||********  REGISTER TO MANOK NI LOLA  *******||");
                    System.out.println("||                                            ||");
                    System.out.println("||            Please enter your details       ||");
                    System.out.println("||                                            ||");
                    System.out.println("||============================================||");
